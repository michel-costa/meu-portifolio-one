# Alura Portifólio: T6 Challenge 2 Front-end Alura

<div id='top'></div>

Hey, devs!

Neste repositório você encontrará um pouco da minha história e das tecnologias que estou estudando, esse projeto **Meu Portifólio**, foi desenvolvido como resultado de um Desafio Front-End (T6) exclusivo para alunos da escola de tecnologia [Alura](https://www.alura.com.br).
...
| Michel Costa |   |
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ✨ Nome        | **Portifólio** - Challenge Alura |
| 🏷️ Tecnologias |HTML, CSS, JavaScript |

<img src="/src/assets/imgs/form.jpg" alt="Descrição da imagem">
